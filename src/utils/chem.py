# this file is taken directly from the original repository of the paper in order to reproduce the same proxy model
...
def onehot(arr, num_classes, dtype=np.int_):
    arr = np.asarray(arr, dtype=np.int_)
